...
@view_config(context=Nodes, renderer='json', request_method='GET')
...
@view_config(
    context=Node, renderer='json', request_method='GET',
    permission='view')
...
@view_config(context=Node, renderer='json', request_method='DELETE',
             permission='delete')
